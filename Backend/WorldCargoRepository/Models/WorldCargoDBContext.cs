...
{
    public partial class WorldCargoDBContext : DbContext
    {
        readonly string _connectionString;

        public WorldCargoDBContext(string connectionString)
        {
            _connectionString = connectionString;
        }

        public WorldCargoDBContext(DbContextOptions<WorldCargoDBContext> dbContextOptions) : base(dbContextOptions)
        {
